            ...
            <React.Fragment>
                <div className="menubar">
                    <div className="kyndalogo">
                        <img src={kyndaletter} alt="kyndalogo" width="104" height="55" />
                    </div>
                    ...
                    <div className="kyndacog">
                        <img src={cog} alt="settings" width="40" height="40" />
                    </div>
                </div>
                <div className="optiebar">
                    <button className="bewerkopties" onClick={() => bewerkopties('bestand')}>
                        Bestand
                    </button>
                    <button className="bewerkopties" onClick={() => bewerkopties('start')}>
                        Start
                    </button>
                    <button className="bewerkopties" onClick={() => bewerkopties('invoegen')}>
                        Invoegen
                    </button>
                </div>
                ...
                <div className="designnaam" onClick={() => bewerkoptiessluiten()}>
                    Design naam
                </div>
                <div className="designpage">
                    <img
                        ...
                        height="44"
                    />
                    <div className="innerdesignpage" onClick={() => bewerkoptiessluiten()}>
                        <div>
                            <iframe id="templatepage1" className="templatepage"></iframe>
                            <br />
                            <h5 className="pagenum">Pagina nummer: 1</h5>
                        </div>
                        <div>
                            <iframe id="templatepage2" className="templatepage"></iframe>
                            <br />
